#ifndef __DRIVER_BTM_SIA_H__

#define __DRIVER_BTM_SIA_H__
...
#define BITMAIN_DEFAULT_BAUD            3000000
...
// how many BM1720 on 1 A3 Hash board
#define A3_MINER_ASIC_NUM_EACH_CHAIN            60
#define ASIC_NUM_EACH_CHAIN                     A3_MINER_ASIC_NUM_EACH_CHAIN
//#define CHAIN_ASIC_NUM                        60
#define A3_MINER_CHIP_ADDR_INTERVAL             (0x100 / ASIC_NUM_EACH_CHAIN)
// Each Chain support max sensor number
#define BITMAIN_MAX_SUPPORT_TEMP_CHIP_NUM       3
// the real number sensor on each hash board
#define A3_MINER_REAL_TEMP_CHIP_NUM             1
#define BITMAIN_REAL_TEMP_CHIP_NUM              A3_MINER_REAL_TEMP_CHIP_NUM
...
/****************** about A3 Hash board end ******************/


/******************** about BM1720 ASIC ********************/

// how many cores in BM1720
#define BM1720_CORE_NUM                             100

// BM1720 ASIC input/output data header
#define INPUT_HEADER_1                              0x55
#define INPUT_HEADER_2                              0xAA
#define OUTPUT_HEADER_1                             0xAA
#define OUTPUT_HEADER_2                             0x55

// BM1720 ASIC input data length
...
// BM1720 ASIC output data length
...
#define CORE_ENABLE1                                0x50
#define CORE_ENABLE2                                0x54
#define CORE_ENABLE3                                0x58
#define CORE_ENABLE4                                0x5C
...
struct bitmian_sia_info_with_index
{
    struct bitmain_sia_info *info;
    uint8_t chain_index;
}__attribute__((packed, aligned(4)));

struct bitmain_sia_info
{
...
struct work_sia
{
    ...
    uint8_t work[WORK_DATA_INPUT_LENGTH];   // 0-75 bytes are sia work; 76-79 are start nonce field
...
struct work_buf
{
    ...
    uint8_t p_rd;
    uint8_t work_num;
    struct work_sia workdata[BITMAIN_MAX_CHAIN_NUM];
} __attribute__((packed, aligned(4)));
*/
