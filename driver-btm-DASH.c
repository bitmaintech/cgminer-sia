...
void tty_init_chain(int which_chain, struct bitmain_DASH_info *info, int baud)
{
    int ret;
...
#ifdef UP_FREQ_MODE
    sleep(1);
    every_chain_set_voltage_PIC16F1704_new(810);
    every_chain_save_freq_PIC16F1704_new(537);
    sleep(1);
#endif
